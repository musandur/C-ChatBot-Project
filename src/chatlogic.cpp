...
ChatLogic::ChatLogic()
{
    ...
    //_chatBot = new ChatBot("../images/chatbot.png");   //chatlogic has no ownership of _chatBot anymore

    // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
    //_chatBot->SetChatLogicHandle(this);   // chatlogic has no ownership of _chatBot anymore
...
ChatLogic::~ChatLogic()
{
    ...
    // delete _chatBot;     // chatlogic has no ownership of _chatBot anymore

    // delete all nodes
    // No need to delete anymore, smart pointer
